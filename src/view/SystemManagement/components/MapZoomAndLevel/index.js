...
export default class MapView extends React.Component {
  ...
  initMap = (map) => {
    ...
    if(zoomLevelCenter && zoomLevelCenter.zoom && zoomLevelCenter.center && !this.init){
  ...
  render() {
    const {zoomLevelCenter,showMapInfo=true,title={}, editable=true, showPoints=true }=this.props
